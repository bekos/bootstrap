describe('pagination directive', function () {
  ...
  beforeEach(inject(function(_$compile_, _$rootScope_) {
    ...
    element = $compile('<pagination total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
    $rootScope.$digest();
  }));
  ...
  describe('`items-per-page`', function () {
    beforeEach(inject(function() {
      $rootScope.perpage = 5;
      element = $compile('<pagination total-items="total" items-per-page="perpage" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('executes  `ng-change` expression', function () {
    beforeEach(inject(function() {
      ...
      element = $compile('<pagination total-items="total" ng-model="$parent.currentPage" ng-change="$parent.selectPageHandler()"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('with `max-size` option', function () {
    beforeEach(inject(function() {
      ...
      $rootScope.currentPage = 3;
      $rootScope.maxSize = 5;
      element = $compile('<pagination total-items="total" ng-model="$parent.currentPage" max-size="maxSize"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('with `max-size` option & no `rotate`', function () {
    beforeEach(inject(function() {
      ...
      element = $compile('<pagination total-items="total" ng-model="$parent.currentPage" max-size="maxSize" rotate="rotate"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('pagination directive with `boundary-links`', function () {
    beforeEach(inject(function() {
      element = $compile('<pagination boundary-links="true" total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
    ...
    it('changes "first" & "last" text from attributes', function() {
      element = $compile('<pagination boundary-links="true" first-text="<<<" last-text=">>>" total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
    ...
    it('changes "previous" & "next" text from attributes', function() {
      element = $compile('<pagination boundary-links="true" previous-text="<<" next-text=">>" total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
    ...
    it('changes "first" & "last" text from interpolated attributes', function() {
      ...
      element = $compile('<pagination boundary-links="true" first-text="{{myfirstText}}" last-text="{{mylastText}}" total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
    ...
    it('changes "previous" & "next" text from interpolated attributes', function() {
      ...
      $rootScope.nextText = '>>';
      element = $compile('<pagination boundary-links="true" previous-text="{{previousText}}" next-text="{{nextText}}" total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
  ...
  describe('pagination directive with just number links', function () {
    beforeEach(inject(function() {
      element = $compile('<pagination direction-links="false" total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('with just boundary & number links', function () {
    beforeEach(inject(function() {
      ...
      element = $compile('<pagination boundary-links="true" direction-links="directions" total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('`num-pages`', function () {
    beforeEach(inject(function() {
      ...
      element = $compile('<pagination total-items="total" ng-model="$parent.currentPage" num-pages="numpg"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
  ...
  describe('override configuration from attributes', function () {
    beforeEach(inject(function() {
      element = $compile('<pagination boundary-links="true" first-text="<<" previous-text="<" next-text=">" last-text=">>" total-items="total" ng-model="$parent.currentPage"></pagination>')($rootScope);
      $rootScope.$digest();
    }));
